...
> **注：按 DD-014（2026-06-10），本条已松绑为"相关尺度必填、其余显式标注 N/A"。详见 `docs/design-decisions.md`。**
...
> **注：按 DD-014（2026-06-10），实施改为"先验证后扩展"——先完成 A²/O 纵切片（见 docs 中 2026-06-10 系列文档），13 领域同时铺开转为后续待办。**
