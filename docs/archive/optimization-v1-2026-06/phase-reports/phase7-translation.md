...
**1. 利用壳聚糖的氨基和羟基进行络合吸附，pH 响应控制吸附/脱附**
...
**1. 利用 DNA 适配体的特异性识别和结合能力进行目标污染物检测和捕获**
...
**1. 利用龙虾外骨骼的几丁质-蛋白质复合结构设计高强度吸附材料**
...
**1. 利用红树林根系的多孔结构和表面官能团进行污染物过滤和吸附**
...
**1. 利用贻贝足丝蛋白 DOPA 的邻苯二酚基团进行表面功能化，通过双齿配位捕获软金属离子**
...
**2. 利用酰胺肟基团对铀酰离子的高选择性配位，实现海水中 ppb 级铀的捕获**
...
**1. 利用 PDA 涂层的邻苯二酚和胺基双功能基团进行表面改性，实现普适性粘附和污染物捕获**
